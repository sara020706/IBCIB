...
const CATTLE_BREEDS: BreedInfo[] = [
  ...
  { name: 'Kasaragod', origin: 'Kerala', description: 'Dwarf breed adapted to coastal areas' },
  ...
  { name: 'Gangatiri', origin: 'Uttar Pradesh', description: 'Good milch breed of Gangetic plains' },
  { name: 'Ponwar', origin: 'Uttar Pradesh', description: 'Draught breed of eastern UP' },
  { name: 'Deoni', origin: 'Maharashtra', description: 'Dual-purpose breed with spotted coat' },
  { name: 'Dangi', origin: 'Maharashtra', description: 'Medium-sized draft breed' },
  { name: 'Gaolao', origin: 'Maharashtra', description: 'Heavy draft breed with white coat' },
  { name: 'Krishna Valley', origin: 'Karnataka', description: 'River basin breed for draft work' },
  { name: 'Bachaur', origin: 'Bihar', description: 'Compact breed suited for agriculture' },
  { name: 'Mewati', origin: 'Rajasthan', description: 'Dual-purpose breed of Mewat region' },
  { name: 'Nimari', origin: 'Madhya Pradesh', description: 'Medium-sized draft breed' },
  { name: 'Malvi', origin: 'Madhya Pradesh', description: 'Strong and sturdy working cattle' },
];
